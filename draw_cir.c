...
#define NUM 1000 //划分的份数

   //椭圆   1
  	void drawC_1( LCell Cell, LLayer Layer,  double offsetX, double offsetY )
	{
	    int i=0;		int	cnt	= NUM;//划分的份数
		float x[NUM],y[NUM];
		float c= 0;//单位nm ，可以通过SIZE调整单位
		float b= 74635;
	...
	void  drawRowland()
	{
		...
		/* 获取当前图层 */
		LLayer Layer_Poly = LLayer_Find( File_Now, "Metal1" );
		if ( !Layer_Poly )
		{
